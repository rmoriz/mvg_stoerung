    ...
    def test_real_api_call(self):
        ...
        try:
            ...
            if isinstance(data, dict):
                ...
                self.assertTrue(has_expected_structure, f"API response doesn't have expected structure: {list(data.keys())}")
            ...
            "messages": [
                {
                    ...
                    "publicationDuration": {"from": 1704110445000, "to": 1704117645000},
                    "incidentDurations": [{"from": 1704110445000, "to": 1704117645000}],
                    "lines": [
